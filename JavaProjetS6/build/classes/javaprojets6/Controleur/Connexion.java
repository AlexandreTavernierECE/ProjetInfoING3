...
public class Connexion {
    ...
    /** retourne un tableau de string avec les elements de chaque classes */
    ...
    /** retourne un tableau de string avec les elements de la recherche */
    public String[][] tabrecherche(String table, String attribut, String valeur) throws SQLException {

        
        rset = stmt.executeQuery("SELECT * FROM " +table+" WHERE "+attribut+" LIKE "+"'"+valeur+"'");
        rsetMeta = rset.getMetaData();
        int nbColonne = rsetMeta.getColumnCount();
